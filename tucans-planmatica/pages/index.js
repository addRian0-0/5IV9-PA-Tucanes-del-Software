          ...
          <div className={styles.container_1}>
            ...
            <center>
              <div className={styles.container_3}>
                ...
                <h4><Link href="https://github.com/Kiramasu2003" passHref><a target="_blank">Arce Roldán Sergio Elías</a></Link>, <Link href="https://github.com/Rafael260401" passHref><a target="_blank">Castañeda Rodriguez Rafael Gil</a></Link>, <Link href="https://github.com/addRian0-0" passHref><a target="_blank">Flores Zamora Ithan Adrián</a></Link>, <Link href="https://github.com/AlfredoGV77" passHref><a target="_blank">Gutiérrez Villalobos José Alfredo</a></Link> y <Link href="https://github.com/ThinKreations" passHref><a target="_blank">Nápoles Munguía José de Jesús</a></Link>; siendo todos unos desarrolladores con experiencia.</h4>
                <br/>
